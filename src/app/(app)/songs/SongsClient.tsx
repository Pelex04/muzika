      ...
      <div className="max-w-[1080px] mx-auto px-5 md:px-9 py-5 md:py-8">
        ...
        <div className="hidden md:flex items-center justify-between mb-7">
          <div>
            ...
            <h1 className="text-3xl font-black text-white tracking-tight">Songs</h1>
          </div>
          <button className="w-9 h-9 rounded-[9px] bg-[#282828] grid place-items-center text-[#b3b3b3] hover:bg-[#3a3a3a]">
            ...
            <button
              ...
              className={cn(
                ...
                (g === 'All' ? !activeGenre : activeGenre === g)
                  ...
                  : 'bg-transparent border-[#3a3a3a] text-[#b3b3b3] hover:border-blue-500 hover:text-blue-400'
              )}
            >
              {g}
            </button>
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <span className="text-sm text-[#717171]">{filtered.length} tracks</span>
        </div>
